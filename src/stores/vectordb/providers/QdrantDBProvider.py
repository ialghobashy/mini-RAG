...
class QdrantDBProvider(VectorDBInterface):
    ...
    def create_collection(self, collection_name: str,
        ...
        # FIXED: Added (collection_name) to actually call the function
    ...
    def insert_one(self, collection_name: str, text: str, vector: list,
                   metadata: dict = None, record_id: str = None): # FIXED: recor_id -> record_id
        ...
        try:
            _ = self.client.upload_records(
                ...
                records=[
                    models.Record(
                        id=record_id, # FIXED: removed [] around record_id
                        vector=vector,
                        payload={
    ...
    def insert_many(self, collection_name: str, texts: list, vectors: list,
                    metadata: list = None, record_ids: list = None, batch_size: int = 50): # FIXED: recor_ids -> record_ids
        
        if metadata is None:
            metadata = [None] * len(texts) # FIXED: [None * len] -> [None] * len
